      ...
      return message.channel.send({
        embeds: [
          new EmbedBuilder()
            .setColor(parseInt("0xc7b700", 16))
            .setDescription(
              `${client.emoji.cross} | Your highest role must be higher than my highest role to use this command.`
            ),
        ],
      });
    }
        ...
        return message.channel.send({
          embeds: [
            new EmbedBuilder()
              .setColor(parseInt("0xc7b700", 16))
              .setDescription(
                `${client.emoji.cross} | You cannot add any voice channels as media channels.`
              ),
          ],
        });
      }
