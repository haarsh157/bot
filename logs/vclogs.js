  ...
  client.on("voiceStateUpdate", async (oldState, newState) => {
    ...
    if (!oldState.channelId && newState.channelId) {
      ...
      const joinEmbed = new EmbedBuilder()
        ...
        .setFooter({
          text: `${member.user.tag} joined voice channel`,
          iconURL: member.displayAvatarURL({ dyanmic: true }),
        })
        .setTimestamp();
    ...
    if (oldState.channelId && !newState.channelId) {
      ...
      const leaveEmbed = new EmbedBuilder()
        ...
        .setFooter({
          text: `${member.user.tag} Leaved voice channel`,
          iconURL: member.displayAvatarURL({ dyanmic: true }),
        })
        .setTimestamp();
    ...
    if (oldState.channelId !== newState.channelId) {
      ...
      const moveEmbed = new EmbedBuilder()
        ...
        .setFooter({
          text: `${member.user.tag} got moved from voice`,
          iconURL: member.displayAvatarURL({ dyanmic: true }),
        })
        .setTimestamp();
